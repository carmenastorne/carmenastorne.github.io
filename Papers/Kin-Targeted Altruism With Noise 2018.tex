...
\\
\bigskip \bigskip
%Can pure altruism generate strategic altruism when kin recognition is noisy? We study a prisoners' dilemma where individuals exhibit altruistic preferences towards kin. The opponent is kin with a known probability, but players only observe a noisy private signal of relatedness. When the game is played for two periods, uncertainty about relatedness adds strategic considerations even under small odds of being related. There are Perfect Bayesian Equilibria where players cooperate in the first round even after getting a negative kin signal. Since players can make inferences about their opponent's signal based on first period actions, non-relatives mimic kin to induce second-period cooperation.
